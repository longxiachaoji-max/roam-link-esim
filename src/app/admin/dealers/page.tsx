...
import { BadgeCheck, Banknote, Building2, Search, WalletCards } from 'lucide-react';
...
export default function AdminDealersPage() {
  ...
  const load = useCallback(async () => {
    ...
    if (response.ok) { setDealers(result.dealers || []); setTopups(result.topupRequests || []); }
  ...
  return <div className="mx-auto max-w-7xl pb-20">
    <div className="mb-7"><h1 className="text-2xl font-black">經銷商專區</h1><p className="mt-1 text-sm text-white/45">審核帳號、個別售價比例、現金加值與帳戶狀態</p></div>
