...
export const ESIM_DESTINATIONS: EsimDestination[] = [
  ...
  },
  {
    ...
    highlights: ['依抵港與離港時間選擇完整使用天數', '比較每日流量、總量型與吃到飽方案', '需要分享給筆電或同行裝置時，先確認熱點額度'],
    guides: [
      {
        title: '香港網卡與香港 eSIM 怎麼選？',
        body: '手機支援 eSIM 且未鎖定電信商，即可在旅程出發前完成安裝，不必更換原本 SIM 卡。選購時請將抵達日與離境日納入，再比較流量、熱點與起算規則。'
      },
      {
        title: '香港 eSIM 吃到飽還是流量型？',
        body: '長時間看影片、直播、工作視訊或分享熱點，可優先比較吃到飽與較大高速額度。主要使用地圖、通訊、叫車及查詢資訊，則每日流量或總量型通常較容易控制預算。'
      },
      {
        title: '香港旅遊需要多少流量？',
        body: '以地圖、叫車、LINE、餐廳與景點查詢為主，可依每日或總流量選擇。若會長時間觀看影片、上傳高畫質影像、工作視訊或分享熱點，建議選較大高速額度或吃到飽方案。'
      }
    ],
    faqs: [
      { question: '香港 eSIM 可以在香港各區使用嗎？', answer: '香港方案通常可在港島、九龍與新界等主要地區使用，實際訊號會依合作電信網路、所在位置與室內環境而異。' },
      { question: '去香港幾天要買幾天方案？', answer: '建議把抵達日與離境日都算入，並確認方案採曆日制或連續 24 小時計算。' },
      { question: '香港 eSIM 吃到飽和流量型怎麼選？', answer: '影音、工作或熱點需求高可比較吃到飽；以地圖、叫車、通訊及查詢資訊為主，可依每日或總流量選擇。' },
      { question: '香港 eSIM 可以分享熱點嗎？', answer: '不同方案的熱點支援與額度不同，購買前請查看方案頁顯示的熱點分享說明。' },
      { question: '香港 eSIM 什麼時候安裝？', answer: '建議於啟用日前或旅程出發前，在穩定 Wi-Fi 環境完成安裝，抵達後再依方案說明開啟行動數據。' },
      { question: '香港 eSIM 需要更換原本 SIM 卡嗎？', answer: '不需要。支援雙 SIM 的手機可保留原門號接收簡訊，並將行動數據切換到香港 eSIM。' }
    ]
  },
  {
    slug: 'indonesia',
    ...
    flag: '🇮🇩',
    countries: ['印尼'],
    title: '印尼 eSIM 推薦｜巴厘島、雅加達旅遊網卡與吃到飽方案',
    description: '比較印尼 eSIM、印尼網卡、巴厘島上網、每日流量、總量型與吃到飽方案，依旅遊天數、熱點與網路需求選擇。',
    intro: '前往印尼巴厘島、雅加達、日惹、龍目島或其他旅遊地區，可依行程天數與使用量比較印尼 eSIM。安裝後無需抽換原本 SIM 卡，可用於地圖、叫車、翻譯、通訊與分享旅程。',
    keywords: [
      '印尼 eSIM',
      '印尼 eSIM 推薦',
      '印尼網卡',
    ...
    highlights: ['依巴厘島或跨島行程的完整天數選擇方案', '比較每日流量、總量型與吃到飽使用規則', '前往離島或郊區時先確認合作電信網路與熱點規則'],
    guides: [
      {
        title: '印尼網卡與印尼 eSIM 怎麼選？',
        body: '手機支援 eSIM 且未鎖定電信商，即可在出發前完成安裝，不必更換原本 SIM 卡。選購時請將抵達日與離開日都納入，再比較流量與起算規則。'
      },
      {
        title: '巴厘島 eSIM 需要多少流量？',
        body: '以 Google Maps、Grab、LINE、餐廳與景點查詢為主，可依每日或總流量選擇。若會長時間看影片、上傳高畫質影像、工作視訊或分享熱點，建議選較大高速額度或吃到飽方案。'
      },
      {
        title: '印尼跨島旅遊的網路選擇',
        body: '印尼國土由多個島嶼組成，城市、山區、海島與室內訊號可能不同。若行程橫跨巴厘島、爪哇島或其他離島，請先查看方案涵蓋與當地合作網路。'
      }
    ],
    faqs: [
      { question: '印尼 eSIM 可以在巴厘島使用嗎？', answer: '涵蓋印尼的全國型方案通常可在巴厘島使用，實際訊號會依當地合作電信網路、位置與地形而異。' },
      { question: '印尼 eSIM 可以跨島使用嗎？', answer: '印尼全國型方案通常可跨城市或島嶼使用，但偏遠地區與離島的訊號仍受當地網路涵蓋影響。' },
      { question: '印尼 eSIM 吃到飽和流量型怎麼選？', answer: '影音、工作或熱點需求高可比較吃到飽；以地圖、叫車、通訊和查詢資訊為主，可選每日或總量型。' },
      { question: '印尼 eSIM 可以分享熱點嗎？', answer: '不同方案的熱點支援與額度不同，購買前請以方案頁顯示的熱點說明為準。' },
      { question: '印尼 eSIM 什麼時候安裝？', answer: '建議於啟用日前或旅程出發前，在穩定 Wi-Fi 環境完成安裝，抵達後再依方案說明開啟行動數據。' },
      { question: '印尼 eSIM 需要實名認證嗎？', answer: '部分當地電信方案可能要求 KYC 實名驗證，如有要求會在商品備註中說明。' }
    ]
  },
  {
    slug: 'taiwan',
    ...
    flag: '🇹🇼',
    countries: ['台灣'],
    title: '台灣短期 eSIM｜臨時上網免月租、免綁長約',
    description: '比較台灣短期 eSIM、臨時上網、吃到飽與流量型方案，不用申辦月租門號或綁長約，適合來台旅遊、返台、出差、探親與備用網路。',
    intro: '來台旅遊、返台探親、短期出差、臨時需要第二條網路或原門號故障時，可按使用天數購買台灣 eSIM，不必申辦月租門號或綁長約。依台北、台中、台南、高雄、花蓮、離島或環島行程，比較流量、效期、合作網路與熱點規則。',
    keywords: [
      '台灣 eSIM',
      '台灣 eSIM 推薦',
      '台灣網卡',
    ...
    highlights: ['按需要的天數選購，不必申辦月租或綁長約', '適合來台、返台、出差、探親與臨時備用網路', '環島、花東或離島行程先確認涵蓋、合作網路及熱點'],
    guides: [
      {
        title: '來台旅遊要選台灣網卡還是 eSIM？',
        body: '手機支援 eSIM 且未鎖定電信商，可在出發前完成安裝，不需更換原本 SIM 卡，也不用為幾天或幾週的需求申辦月租長約。目前本站上架的台灣方案皆免 KYC、免證件核驗。'
      },
      {
    ...
    faqs: [
      { question: '台灣 eSIM 適合哪些臨時需求？', answer: '適合來台旅遊、返台探親、短期出差、活動工作、原門號故障或暫時需要第二條行動網路。可依商品效期按天選購，不必申辦月租門號或綁長約。' },
      { question: '外國旅客可以使用台灣 eSIM 嗎？', answer: '可以。手機支援 eSIM 且未鎖定特定電信商即可使用；目前本站上架的台灣方案皆免 KYC、免證件核驗。' },
      { question: '台灣短期 eSIM 有台灣電話號碼嗎？', answer: '不一定。免 KYC 是指不需上傳證件，不能據此推定方案含台灣門號、語音或簡訊；需要接聽電話或收驗證碼時，請選購前確認商品功能。' },
      ...
      { question: '台灣 eSIM 需要實名認證嗎？', answer: '目前本站上架的台灣 eSIM 方案全部免 KYC、免實名與證件核驗，可直接依方案流程購買及安裝。' }
    ]
  },
  {
    slug: 'philippines',
    ...
    flag: '🇵🇭',
    countries: ['菲律賓'],
    title: '菲律賓 eSIM 推薦｜宿霧、馬尼拉與長灘島旅遊網卡',
    description: '比較菲律賓 eSIM、菲律賓網卡、吃到飽、每日流量與總量型方案，適合宿霧、馬尼拉、長灘島與薄荷島旅遊上網。',
    intro: '前往菲律賓自由行，可依宿霧、馬尼拉、長灘島、薄荷島或其他行程的完整天數，比較菲律賓 eSIM 吃到飽、每日流量與總量型方案。免更換實體 SIM 卡，可用於地圖、叫車、翻譯、通訊與分享旅程。',
    keywords: [
      '菲律賓 eSIM',
      '菲律賓 eSIM 推薦',
      '菲律賓網卡',
    ...
    highlights: ['依跳島或跨城市行程的完整天數選擇', '比較吃到飽、每日流量與總量型使用規則', '方案可使用 Smart 與 Globe 網路，實際訊號依所在地區而異'],
    guides: [
      {
        title: '菲律賓網卡與菲律賓 eSIM 怎麼選？',
        body: '手機支援 eSIM 且未鎖定電信商，即可於旅程前完成安裝，不需抽換原本 SIM 卡。請將抵達日與離境日都納入，再比較天數、流量與起算規則。'
      },
      {
        title: '宿霧、長灘島與薄荷島需要多少流量？',
        body: '以地圖、叫車、LINE、餐廳與景點查詢為主，可依每日或總流量選擇。若會長時間看影片、上傳高畫質影像、工作視訊或分享熱點，建議選擇較大高速額度或吃到飽方案。'
      },
      {
        title: '菲律賓跳島行程的網路選擇',
        body: '城市、山區、碼頭、離島與室內訊號可能不同。方案支援的 Smart、Globe 等當地網路會依地點自動連線，實際訊號以當地基地台與環境為準。'
      }
    ],
    faqs: [
      { question: '菲律賓 eSIM 可以在宿霧和馬尼拉使用嗎？', answer: '涵蓋菲律賓的全國型方案通常可跨城市使用，實際訊號會依當地合作電信網路、位置與地形而異。' },
      { question: '菲律賓 eSIM 可以在長灘島與薄荷島使用嗎？', answer: '菲律賓全國型方案通常可於主要觀光地區使用，但離島、航行中或偏遠地區的訊號仍受當地網路涵蓋影響。' },
      { question: '菲律賓 eSIM 吃到飽和流量型怎麼選？', answer: '影音、工作或熱點需求高可比較吃到飽；以地圖、叫車、通訊和查詢資訊為主，可選每日或總量型。' },
      { question: '菲律賓 eSIM 使用哪些電信網路？', answer: '目前上架方案的商品資料標示 Smart 與 Globe，不同方案仍應以獨立方案頁顯示的電信業者為準。' },
      { question: '菲律賓 eSIM 可以分享熱點嗎？', answer: '不同方案的熱點支援與額度不同，購買前請查看方案頁的熱點說明。' },
      { question: '菲律賓 eSIM 什麼時候安裝？', answer: '建議於啟用日前或旅程出發前，在穩定 Wi-Fi 環境完成安裝，抵達後再依方案說明開啟行動數據。' }
    ]
  }
];
