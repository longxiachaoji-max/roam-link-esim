...
export const ESIM_DESTINATIONS: EsimDestination[] = [
  ...
  },
  {
    ...
    description: '比較香港 eSIM、香港旅遊網卡、每日流量、總量型與吃到飽方案，依停留天數、價格及熱點需求選擇，部分方案亦涵蓋中國與澳門。',
    intro: '前往香港自由行、探親或出差，可依停留天數與使用量比較香港 eSIM。本站目前上架的香港適用方案亦涵蓋中國與澳門，適合香港單地行程，也方便臨時跨境前往深圳或澳門。',
    keywords: [
      '香港 eSIM',
      '香港 eSIM 推薦',
      '香港網卡',
    ...
    highlights: ['依抵港與離港時間選擇完整使用天數', '比較每日流量、總量型與吃到飽方案', '目前方案涵蓋中國、香港與澳門，跨境行程不需重新安裝'],
    guides: [
      {
      ...
      {
        title: '香港、深圳與澳門跨境如何上網？',
        body: '目前香港頁列出的方案同時涵蓋中國、香港與澳門。跨境後通常不需要重新安裝，裝置會搜尋當地合作網路；實際涵蓋及使用限制仍以各方案說明為準。'
      }
    ],
    faqs: [
      { question: '香港 eSIM 可以只在香港使用嗎？', answer: '可以。目前列出的方案雖亦涵蓋中國與澳門，但只在香港停留也能正常使用。' },
      { question: '香港 eSIM 可以在深圳或澳門使用嗎？', answer: '目前香港頁上架的是中港澳跨區方案，可在中國、香港與澳門使用，實際涵蓋請以商品頁說明為準。' },
