...
export const ESIM_DESTINATIONS: EsimDestination[] = [
  ...
  },
  {
    ...
    guides: [
      {
        ...
        body: '手機支援 eSIM 且未鎖定電信商，可在出發前完成安裝，不需更換原本 SIM 卡，也不用為幾天或幾週的需求申辦月租長約。仍要依商品確認流量、效期、啟用與身分驗證規則。'
      },
      {
    ...
    faqs: [
      ...
      { question: '外國旅客可以使用台灣 eSIM 嗎？', answer: '手機支援 eSIM 且未鎖定特定電信商即可使用；個別方案如有 KYC 或身分驗證要求，仍須依商品備註完成。' },
      { question: '台灣短期 eSIM 有台灣電話號碼嗎？', answer: '不一定。旅遊 eSIM 多為數據服務，不應預設包含台灣門號、語音或簡訊；需要接聽電話或收驗證碼時，請選購前確認商品功能及身分驗證要求。' },
